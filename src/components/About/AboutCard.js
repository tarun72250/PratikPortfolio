      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in">
          <p style={{ textAlign: "justify"}}>
            Hi Everyone, I am <span className="primary-header">Pratik Khadse</span> from Bhuswal, Maharashtra, India. I am a Full Stack Developer and a passionate programmer.
            <br />
            <br />
